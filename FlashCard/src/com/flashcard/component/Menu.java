...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("2", "Quản lý thẻ", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("3", "Quản lý từ vựng", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("4", "Kiểm tra", Model_Menu.MenuType.MENU));
        ...
        listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
        listMenu1.addItem(new Model_Menu("8", "Cài đặt ", Model_Menu.MenuType.MENU));
    ...
    private void initComponents() {
       ...
       /// jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/flashcard/icon/logo.png"))); // NOI18N
        String logoPath = "src/com/flashcard/icon/logo.png";
        File logoFile = new File(logoPath);
        if (logoFile.exists()) {
        	jLabel1.setIcon(new ImageIcon(logoFile.getAbsolutePath()));
        } else {
            System.out.println("Icon not found at " + logoPath);
        }
