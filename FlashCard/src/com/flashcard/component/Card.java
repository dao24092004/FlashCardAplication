...
public class Card extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        //lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/flashcard/icon/stock.png"))); // NOI18N
        String stockPath = "src/com/flashcard/icon/stock.png";
        File stockFile = new File(stockPath);
        if (stockFile.exists()) {
        	lbIcon.setIcon(new ImageIcon(stockFile.getAbsolutePath()));
        } else {
